...
foreach ($prod_noaa as $name => $prod_dataset) {
    if (isset($json_backup_noaa_by_guid[$prod_dataset['guid']])) {
        foreach ($json_backup_noaa_by_guid[$prod_dataset['guid']] as $json_backup_dataset) {
            $csv->writeRow([
                $prod_dataset['title'],
                $prod_dataset['url'],
                $prod_dataset['guid'],
    ...
    if (isset($json_backup_noaa_by_title[$prod_dataset['title_simple']])) {
        foreach ($json_backup_noaa_by_title[$prod_dataset['title_simple']] as $json_backup_dataset) {
            $csv->writeRow([
                $prod_dataset['title'],
                $prod_dataset['url'],
                $prod_dataset['guid'],
