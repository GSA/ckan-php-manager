...
//foreach (glob(DATA_DIR . '/public_package.csv') as $csv_file) {
...
//
//    file_put_contents($results_dir . '/' . $basename . '_add_licese_url.log', $status, FILE_APPEND | LOCK_EX);
//
...
//        }
////        skip headers
//        if (in_array(strtolower($row['0']), ['#', 'id', 'name', 'title', 'license_id'])) {
//            continue;
//        }
//
//        $package_id = $row['2'];
//        $license_id = $row['4'];
//        $CkanManager->update_dataset_license($package_id, $license_id, $basename);
//    }
//}
//
