 ...
 */
define('ORGANIZATION_TO_EXPORT', 'Department of Justice');
...
$termsArray = ['doj-gov' => 'Department of Justice'];
 ...
 */
$results_dir = CKANMNGR_RESULTS_DIR . date('/Ymd-His') . '_EXPORT_DOJ' . PARENT_TERM;
mkdir($results_dir);
