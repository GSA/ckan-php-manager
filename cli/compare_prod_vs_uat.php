...
if (!is_file($results_dir . '/uat.csv')) {
    ...
    $uat_commerce = $UatCkanManager->export_brief('extras_harvest_source_title:Commerce JSON', 'http://uat-catalog-fe-data.reisys.com/dataset/');
...
is_file($results_dir . '/prod_vs_uat_commerce_geospatial.csv') && unlink($results_dir . '/prod_vs_uat_commerce_geospatial.csv');
$csv = new Writer($results_dir . '/prod_vs_uat_commerce_geospatial.csv');
$csv->writeRow([
    'Prod Title',
    'Prod URL',
    'Prod Topics',
