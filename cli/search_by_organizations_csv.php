...
if (!is_readable($keywords_file_path = CKANMNGR_DATA_DIR . '/search_organizations.csv')) {
 ...
 */
$results_dir = CKANMNGR_RESULTS_DIR . date('/Ymd-His') . '_SEARCH_ORGANIZATIONS_' . sizeof($organizations_list);
mkdir($results_dir);
